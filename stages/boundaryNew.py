            ...
            with field_tabs[i]:
                ...
                for boundary_name in patch_boundaries:
                    with st.expander(f"{boundary_name}"):
                        ...
                        current_type = default_Dict.get("type", "fixedValue")
                        ...
                        bc = generate_boundary_condition(field, boundary_name, selected_bc_type, default_Dict)

                        # Pre-select Function1 types outside the form
                        preselect_function1_types(field, boundary_name, bc)
                        ...
                        with st.form(f"boundary_conditions_{field}_{boundary_name}"):
                            ...
                            bc = bc.render_ui(field, boundary_name, use_f1_types_from_session=True)
